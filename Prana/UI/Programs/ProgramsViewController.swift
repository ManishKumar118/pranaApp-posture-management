...
//                titleLabel.text = "Custom Training"
        ...
        if UserDefaults.standard.value(forKey: "CheckSelectedStatus") as? Bool == true
        {
    ...
    func getCellForType(_ type: Int) -> UITableViewCell? {
        ...
        case 1:
            ...
            if programType == 0 {
                ...
                chkvaluedays = true
                UserDefaults.standard.set(chkvaluedays, forKey: "CheckSelectedStatus")
